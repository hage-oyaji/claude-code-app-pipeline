...
2. **報告は必ずフォーマットに従え。**
3. **成果物は以下の3ファイルを `artifacts/data-model/` に格納せよ: `er-diagram.md`、`table-definition.md`、`ddl.sql`。**
...
7. **成果物ファイルは内容の有無にかかわらず必ず3ファイル全て作成せよ。** 新規テーブルが不要と判断した場合も、各ファイルに「本工程での新規追加・変更なし — 理由: {理由}」と明記して作成すること。空ファイルのままにするな。
